...
namespace Ava.Infrastructure.Services.PictureService
{
    ...
    public class PictureService : IPictureService
    {
        ...
        public PictureService(IConfiguration configuration)
        {
            ...
            var credentials = new StorageSharedKeyCredential(_configuration["AzureStorage:Account"], _configuration["AzureStorage:Key"]);
            var blobUri = $"https://{_configuration["AzureStorage:Account"]}.blob.core.windows.net";
